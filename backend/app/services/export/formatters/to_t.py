...
def generate_to_t_line(data: Dict[str, Any]) -> str:
    ...
    41-60     CustomerTraceabilityCode 20     String (spazio + MIN_ID senza zeri anteposti + ljust)
    ...
    # MIN_ID senza zeri anteposti (es: 00001 -> "1", 00991 -> "991", 10905 -> "10905")
    min_id_raw = str(data.get('min_id') or data.get('anag_min_id') or '').strip()
    min_id = min_id_raw.lstrip('0') or '0'
    ...
    # Pos 41: spazio, Pos 42+: MIN_ID senza zeri anteposti, resto: spazi (fill fino a 20)
