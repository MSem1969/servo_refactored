...
class BaseExtractor(ABC):
    ...
    def normalize_aic(self, codice: str, descrizione: str = '') -> Dict[str, Any]:
        ...
        IMPORTANTE: Il codice viene mantenuto esattamente come estratto dal PDF.
        Solo i caratteri non numerici vengono rimossi.
        La validazione (9 cifre esatte) avviene successivamente come anomalia AIC-A01.
        ...
        # Estrai solo cifre - NESSUN PADDING/NORMALIZZAZIONE
        codice_num = re.sub(r'[^\d]', '', codice)

        if not codice_num:
            is_no_aic = True

        # RIMOSSO: Normalizzazione a 9 cifre
        # Il codice rimane esattamente come estratto
        # Anomalie AIC-A01 scatteranno per codici != 9 cifre
