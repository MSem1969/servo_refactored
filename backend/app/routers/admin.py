...
async def reset_sistema(
    ...
    """
    Reset completo del sistema per fase di test.
    ...
    - Log operazioni
    - Backup history
    - Sessioni attività (produttività)
    ...
    try:
        ...
        # PRESERVATE: operatori, user_sessions, anagrafica_farmacie, anagrafica_parafarmacie, anagrafica_clienti, listini_vendor, vendor
        tables_to_clear = [
            # Log e audit (prima perché possono avere FK verso altre tabelle)
            "log_operazioni",
            ...
            "tracciati_dettaglio",
            "tracciati",
            # Supervisione (tutte le tipologie)
        ...
        return {
            "success": True,
            "message": "Reset completato. Preservati: utenti, sessioni, farmacie, parafarmacie, clienti, listini.",
