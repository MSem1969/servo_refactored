...
PERMESSI_PER_RUOLO: Dict[RuoloUtente, Set[str]] = {
    ...
    # =========================================================================
    # SUPERUSER - Come supervisore, ma può creare supervisori e vede produttività supervisori
    # =========================================================================
    RuoloUtente.SUPERUSER: {
        # NO backend diretto
        ...
        # Gestione utenti: può creare supervisori e operatori
        Permesso.UTENTI_VIEW_ALL,  # Vede tutti (inclusi supervisori)
        Permesso.UTENTI_CREATE_SUPERVISOR,
        Permesso.UTENTI_CREATE_OPERATOR,
        Permesso.UTENTI_DISABLE_OWN,  # Disabilita solo quelli creati da lui
...
def puo_disabilitare_utente(
    ...
    3. Admin può disabilitare: superuser, supervisori e operatori (tutti)
    4. Superuser può disabilitare: supervisori e operatori creati da lui
    5. Supervisore può disabilitare: solo operatori creati da lui
    6. Operatore e readonly: non possono disabilitare nessuno
    ...
    # Regola 3: Admin può disabilitare superuser, supervisori e operatori
    if ruolo_disabilitante == RuoloUtente.ADMIN:
        return ruolo_target in [RuoloUtente.SUPERUSER, RuoloUtente.SUPERVISORE, RuoloUtente.OPERATORE, RuoloUtente.READONLY]

    # Regola 4: Superuser può disabilitare supervisori e operatori creati da lui
    if ruolo_disabilitante == RuoloUtente.SUPERUSER:
        return (
            ruolo_target in [RuoloUtente.SUPERVISORE, RuoloUtente.OPERATORE] and
            created_by_target == id_disabilitante
        )

    # Regola 5: Supervisore può disabilitare solo operatori creati da lui
    ...
    # Regola 6: Operatore e readonly non possono disabilitare nessuno
    return False
...
HOME_PAGE_PER_RUOLO: Dict[RuoloUtente, str] = {
    ...
    RuoloUtente.SUPERUSER: "/dashboard",
