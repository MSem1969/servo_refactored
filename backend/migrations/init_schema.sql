...
CREATE TABLE IF NOT EXISTS public.acquisizioni (
...
CREATE SEQUENCE IF NOT EXISTS public.acquisizioni_id_acquisizione_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE IF NOT EXISTS public.anagrafica_clienti_id_cliente_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE IF NOT EXISTS public.anagrafica_farmacie (
...
CREATE SEQUENCE IF NOT EXISTS public.anagrafica_farmacie_id_farmacia_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE IF NOT EXISTS public.anagrafica_parafarmacie (
...
CREATE SEQUENCE IF NOT EXISTS public.anagrafica_parafarmacie_id_parafarmacia_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE IF NOT EXISTS public.anomalie_id_anomalia_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE IF NOT EXISTS public.app_sezioni (
...
CREATE TABLE IF NOT EXISTS public.audit_modifiche (
...
CREATE SEQUENCE IF NOT EXISTS public.audit_modifiche_id_audit_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE IF NOT EXISTS public.backup_history_id_backup_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE IF NOT EXISTS public.backup_modules (
    id_module integer NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS public.backup_modules_id_module_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE IF NOT EXISTS public.backup_operations_log_id_log_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE IF NOT EXISTS public.backup_schedules_id_schedule_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE IF NOT EXISTS public.backup_storage_id_storage_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE IF NOT EXISTS public.criteri_ordinari_aic (
...
CREATE TABLE IF NOT EXISTS public.criteri_ordinari_espositore (
...
CREATE TABLE IF NOT EXISTS public.criteri_ordinari_listino (
    pattern_signature text NOT NULL,
    pattern_descrizione text,
    vendor text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.criteri_ordinari_lookup (
    pattern_signature text NOT NULL,
    pattern_descrizione text,
    vendor text NOT NULL,
    codice_anomalia text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.crm_allegati (
...
CREATE SEQUENCE IF NOT EXISTS public.crm_allegati_id_allegato_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE IF NOT EXISTS public.crm_messaggi (
...
CREATE SEQUENCE IF NOT EXISTS public.crm_messaggi_id_messaggio_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE IF NOT EXISTS public.crm_tickets_id_ticket_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE IF NOT EXISTS public.email_acquisizioni (
...
CREATE SEQUENCE IF NOT EXISTS public.email_acquisizioni_id_email_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE IF NOT EXISTS public.esportazioni (
...
CREATE TABLE IF NOT EXISTS public.esportazioni_dettaglio (
    id integer NOT NULL,
    id_esportazione integer NOT NULL,
    id_testata integer
);
...
CREATE SEQUENCE IF NOT EXISTS public.esportazioni_dettaglio_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE IF NOT EXISTS public.esportazioni_id_esportazione_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE IF NOT EXISTS public.listini_vendor (
...
CREATE SEQUENCE IF NOT EXISTS public.listini_vendor_id_listino_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE IF NOT EXISTS public.log_criteri_applicati (
    id_log integer NOT NULL,
    id_testata integer,
...
CREATE SEQUENCE IF NOT EXISTS public.log_criteri_applicati_id_log_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE IF NOT EXISTS public.log_operazioni (
    id_log integer NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS public.log_operazioni_id_log_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE IF NOT EXISTS public.operatori_id_operatore_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE IF NOT EXISTS public.ordini_dettaglio (
...
CREATE SEQUENCE IF NOT EXISTS public.ordini_dettaglio_id_dettaglio_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE IF NOT EXISTS public.ordini_testata (
    id_testata integer NOT NULL,
    id_acquisizione integer NOT NULL,
    ...
    deposito_riferimento character varying(10),
    id_cliente_manuale integer,
    note_cliente_manuale text
);
...
CREATE SEQUENCE IF NOT EXISTS public.ordini_testata_id_testata_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE IF NOT EXISTS public.permessi_ruolo (
...
CREATE SEQUENCE IF NOT EXISTS public.permessi_ruolo_id_permesso_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE IF NOT EXISTS public.sessione_attivita (
    id integer NOT NULL,
    id_operatore integer NOT NULL,
    id_session integer,
...
CREATE SEQUENCE IF NOT EXISTS public.sessione_attivita_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE IF NOT EXISTS public.supervisione_aic (
...
CREATE SEQUENCE IF NOT EXISTS public.supervisione_aic_id_supervisione_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE IF NOT EXISTS public.supervisione_espositore (
    id_supervisione integer NOT NULL,
    id_testata integer NOT NULL,
    id_anomalia integer,
...
CREATE SEQUENCE IF NOT EXISTS public.supervisione_espositore_id_supervisione_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE IF NOT EXISTS public.supervisione_listino (
    id_supervisione integer NOT NULL,
    id_testata integer NOT NULL,
    id_dettaglio integer,
    id_anomalia integer,
...
CREATE SEQUENCE IF NOT EXISTS public.supervisione_listino_id_supervisione_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE IF NOT EXISTS public.supervisione_lookup (
    id_supervisione integer NOT NULL,
    id_testata integer NOT NULL,
    id_anomalia integer,
    codice_anomalia character varying(20),
...
CREATE SEQUENCE IF NOT EXISTS public.supervisione_lookup_id_supervisione_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE IF NOT EXISTS public.supervisione_prezzo (
    id_supervisione integer NOT NULL,
    id_testata integer NOT NULL,
    id_anomalia integer,
...
CREATE SEQUENCE IF NOT EXISTS public.supervisione_prezzo_id_supervisione_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE IF NOT EXISTS public.tracciati_dettaglio_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE IF NOT EXISTS public.tracciati_id_tracciato_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE IF NOT EXISTS public.user_sessions_id_session_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE OR REPLACE VIEW public.v_backup_dashboard AS
 SELECT m.id_module,
    m.nome,
    m.tier,
    m.titolo,
...
CREATE OR REPLACE VIEW public.v_backup_history_detail AS
 SELECT h.id_backup,
    h.backup_type,
    h.file_name,
    h.file_size_bytes,
...
CREATE OR REPLACE VIEW public.v_supervisione_grouped_pending AS
...
CREATE OR REPLACE VIEW public.v_supervisione_listino_pending AS
...
CREATE OR REPLACE VIEW public.v_supervisione_lookup_pending AS
...
CREATE OR REPLACE VIEW public.v_supervisione_pending AS
...
CREATE SEQUENCE IF NOT EXISTS public.vendor_id_vendor_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE INDEX IF NOT EXISTS idx_audit_created ON public.audit_modifiche USING btree (created_at);
...
CREATE INDEX IF NOT EXISTS idx_audit_entita ON public.audit_modifiche USING btree (entita, id_entita);
...
CREATE INDEX IF NOT EXISTS idx_audit_testata ON public.audit_modifiche USING btree (id_testata);
...
CREATE INDEX IF NOT EXISTS idx_backup_history_module ON public.backup_history USING btree (id_module);
...
CREATE INDEX IF NOT EXISTS idx_backup_history_started ON public.backup_history USING btree (started_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_backup_history_status ON public.backup_history USING btree (status);
...
CREATE INDEX IF NOT EXISTS idx_backup_history_type ON public.backup_history USING btree (backup_type);
...
CREATE INDEX IF NOT EXISTS idx_backup_ops_log_created ON public.backup_operations_log USING btree (created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_backup_ops_log_module ON public.backup_operations_log USING btree (id_module);
...
CREATE INDEX IF NOT EXISTS idx_backup_ops_log_operation ON public.backup_operations_log USING btree (operation);
...
CREATE INDEX IF NOT EXISTS idx_backup_schedules_module ON public.backup_schedules USING btree (id_module);
...
CREATE INDEX IF NOT EXISTS idx_backup_schedules_next ON public.backup_schedules USING btree (next_run) WHERE (active = true);
...
CREATE INDEX IF NOT EXISTS idx_backup_storage_stato ON public.backup_storage USING btree (stato);
...
CREATE INDEX IF NOT EXISTS idx_backup_storage_tipo ON public.backup_storage USING btree (tipo);
...
CREATE INDEX IF NOT EXISTS idx_clienti_codice ON public.anagrafica_clienti USING btree (codice_cliente);
...
CREATE INDEX IF NOT EXISTS idx_clienti_localita ON public.anagrafica_clienti USING btree (localita);
...
CREATE INDEX IF NOT EXISTS idx_clienti_piva ON public.anagrafica_clienti USING btree (partita_iva);
...
CREATE INDEX IF NOT EXISTS idx_clienti_provincia ON public.anagrafica_clienti USING btree (provincia);
...
CREATE INDEX IF NOT EXISTS idx_crit_aic_ordinario ON public.criteri_ordinari_aic USING btree (is_ordinario) WHERE (is_ordinario = true);
...
CREATE INDEX IF NOT EXISTS idx_crit_aic_vendor_desc ON public.criteri_ordinari_aic USING btree (vendor, descrizione_normalizzata);
...
CREATE INDEX IF NOT EXISTS idx_crm_messaggi_ticket ON public.crm_messaggi USING btree (id_ticket);
...
CREATE INDEX IF NOT EXISTS idx_crm_tickets_operatore ON public.crm_tickets USING btree (id_operatore);
...
CREATE INDEX IF NOT EXISTS idx_crm_tickets_stato ON public.crm_tickets USING btree (stato);
...
CREATE INDEX IF NOT EXISTS idx_listini_aic ON public.listini_vendor USING btree (codice_aic);
...
CREATE INDEX IF NOT EXISTS idx_listini_vendor ON public.listini_vendor USING btree (vendor);
...
CREATE INDEX IF NOT EXISTS idx_listini_vendor_aic ON public.listini_vendor USING btree (vendor, codice_aic);
...
CREATE INDEX IF NOT EXISTS idx_permessi_ruolo_ruolo ON public.permessi_ruolo USING btree (ruolo);
...
CREATE INDEX IF NOT EXISTS idx_permessi_ruolo_sezione ON public.permessi_ruolo USING btree (codice_sezione);
...
CREATE INDEX IF NOT EXISTS idx_sup_aic_pattern ON public.supervisione_aic USING btree (pattern_signature);
...
CREATE INDEX IF NOT EXISTS idx_sup_aic_stato ON public.supervisione_aic USING btree (stato);
...
CREATE INDEX IF NOT EXISTS idx_sup_aic_testata ON public.supervisione_aic USING btree (id_testata);
...
CREATE INDEX IF NOT EXISTS idx_sup_aic_vendor_desc ON public.supervisione_aic USING btree (vendor, descrizione_normalizzata);
...
CREATE INDEX IF NOT EXISTS idx_sup_listino_stato ON public.supervisione_listino USING btree (stato);
...
CREATE INDEX IF NOT EXISTS idx_sup_listino_testata ON public.supervisione_listino USING btree (id_testata);
...
CREATE INDEX IF NOT EXISTS idx_sup_listino_vendor ON public.supervisione_listino USING btree (vendor);
...
CREATE INDEX IF NOT EXISTS idx_sup_lookup_pattern ON public.supervisione_lookup USING btree (pattern_signature);
...
CREATE INDEX IF NOT EXISTS idx_sup_lookup_stato ON public.supervisione_lookup USING btree (stato);
...
CREATE INDEX IF NOT EXISTS idx_sup_lookup_testata ON public.supervisione_lookup USING btree (id_testata);
...
CREATE INDEX IF NOT EXISTS idx_sup_prezzo_stato ON public.supervisione_prezzo USING btree (stato);
...
CREATE INDEX IF NOT EXISTS idx_sup_prezzo_testata ON public.supervisione_prezzo USING btree (id_testata);
...
CREATE INDEX IF NOT EXISTS idx_supervisione_listino_stato ON public.supervisione_listino USING btree (stato);
...
CREATE INDEX IF NOT EXISTS idx_supervisione_listino_testata ON public.supervisione_listino USING btree (id_testata);
...
CREATE INDEX IF NOT EXISTS idx_supervisione_lookup_stato ON public.supervisione_lookup USING btree (stato);
...
CREATE INDEX IF NOT EXISTS idx_supervisione_lookup_testata ON public.supervisione_lookup USING btree (id_testata);
...
CREATE INDEX IF NOT EXISTS idx_sync_state_last_sync ON public.sync_state USING btree (last_sync);
...
-- Aggiungo constraint UNIQUE mancanti
ALTER TABLE public.operatori ADD CONSTRAINT operatori_username_key UNIQUE (username);
ALTER TABLE public.vendor ADD CONSTRAINT vendor_codice_vendor_key UNIQUE (codice_vendor);

-- Reset sequence operatori
SELECT setval(pg_get_serial_sequence('public.operatori', 'id_operatore'), COALESCE((SELECT MAX(id_operatore) FROM public.operatori), 0) + 1, false);

-- Operatore SYSTEM (id=1)
INSERT INTO public.operatori (id_operatore, username, nome, ruolo, attivo)
VALUES (1, 'SYSTEM', 'Sistema', 'admin', TRUE)
ON CONFLICT (username) DO NOTHING;

-- Reset sequence dopo SYSTEM
SELECT setval(pg_get_serial_sequence('public.operatori', 'id_operatore'), GREATEST(2, COALESCE((SELECT MAX(id_operatore) FROM public.operatori), 0) + 1), false);

-- Utente admin iniziale (password: Admin123!)
INSERT INTO public.operatori (username, password_hash, nome, cognome, ruolo, attivo)
VALUES ('admin', '$2b$12$LvPzfznYiIc9Bl0Pz8RTr.U2/sgjdLw5F0DnWZ9V7NT1VufGZ5SxS', 'Amministratore', 'Sistema', 'admin', TRUE)
ON CONFLICT (username) DO NOTHING;

-- Vendor supportati
INSERT INTO public.vendor (codice_vendor, ragione_sociale, partita_iva_vendor, note_estrazione) VALUES
...
-- Sezioni app per permessi
INSERT INTO public.app_sezioni (codice_sezione, nome_display, ordine_menu) VALUES
    ('dashboard', 'Dashboard', 1),
    ('database', 'Database Ordini', 2),
    ('upload', 'Upload PDF', 3),
    ('report', 'Report', 4),
    ('supervisione', 'Supervisione', 5),
    ('tracciati', 'Tracciati EDI', 6),
    ('anagrafica', 'Anagrafica', 7),
    ('listini', 'Listini', 8),
    ('crm', 'CRM', 9),
    ('admin', 'Amministrazione', 10)
