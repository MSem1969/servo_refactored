...
def upgrade() -> None:
    ...
    indexes = [
        ...
        "CREATE INDEX IF NOT EXISTS idx_dettaglio_stato ON ORDINI_DETTAGLIO(stato)",
        ...
        "CREATE INDEX IF NOT EXISTS idx_anomalie_tipo ON ANOMALIE(tipo)",
        ...
        "CREATE INDEX IF NOT EXISTS idx_sessioni_operatore ON SESSIONI(id_operatore)",
...
def downgrade() -> None:
    ...
    tables = [
        ...
        # Core Auth
        "LOG_ATTIVITA", "SESSIONI", "OPERATORI",
        # Core Orders
