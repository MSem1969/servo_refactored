...
# IMPORTANTE: In produzione, caricare da variabile d'ambiente!
# Esempio: JWT_SECRET_KEY = os.environ.get("JWT_SECRET_KEY")
JWT_SECRET_KEY = "TO_EXTRACTOR_SECRET_KEY_CHANGE_IN_PRODUCTION_2024"
